...
2. Uebernimm von Ingo Dokumentart, Debitor und Artikel.
3. Nutze den Skill erp.create_bc_documents_v01 fuer die Belegerstellung in Business Central.
4. Leite die Dokumentart strikt aus documentType ab:
	- sales_order -> Verkaufsauftrag
	- sales_quote -> Verkaufsangebot
5. Testfall-Regel (verbindlich fuer V0.1-Testphase):
	- sales_order -> documentNo AU27-00001
	- sales_quote -> documentNo AN27-00001
6. Erzeuge den passenden Beleg in Business Central.
7. Gib die erzeugte Belegnummer und den Status an Ingo zurueck.
